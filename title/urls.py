...
urlpatterns = [
	...
	path('inletter/<int:pk>/', views.InletterDetailView.as_view(), name='inletter_detail'),
	...
	path('outletter/<int:pk>/', views.OutletterDetailView.as_view(), name='outletter_detail'),
